...
import { Card, Col, Row, Spin, Popover, Divider, Button, Typography, message } from 'antd';
...
const App = () => {
  ...
  return <>
    ...
    <Text style={{ color: "#D3D3D3" }}>
      &emsp; CopyRight 2021 <Link style={{ color: "#D3D3D3" }} href="https://xsot.cn" target="_blank">xcsoft</Link> All Rights Reserved.
    </Text>
